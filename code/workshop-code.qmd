...
[deployed html url](https://dmatthys12.github.io/workshop-08_winter-2026/code/workshop-code.html)
...
drought_exp_clean <- drought_exp |> 
  # making a new object based on drought_exp dataframe
  clean_names() |> 
  # using the clean_names function to just have lowercase and underscores, then mutating species name column from abbreviation to full scientific name
  ...
  # water treatment column mutated from abbreviation to full description
...
ggplot(data = drought_exp_clean, 
  ...
  scale_color_manual(values = c(
    ...
    "Encelia californico" = enccal_col,
...
Best model is model4: the on ethat includes only water treatment and species.
...
This is the model prediction for the difference between Escholzia californica mass in the well watered treatment and Lotus scoparius mass in the well watered treatment. The model predicts that this difference is 0.23 +/- 0.03 (SE) g.
